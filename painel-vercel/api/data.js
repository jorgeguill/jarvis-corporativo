...
function buildData(){
    var DATA={
      SKAL:{nome:'SKAL Engenharia',status:'aten',dados:true,
        ...
        eventos:[
          {t:'crit',tp:'Crítico',tt:'Inadimplência acima de 90 dias em R$ 670,4 mil — 80% da dívida. O total caiu de 848,2 para 833,9 mil (entrou dinheiro), mas o +90 não cede: a recuperação vem do novo (0–30), a dívida velha continua parada.',q:'Detalhe a inadimplência acima de 90 dias e o que fazer para recuperar.'},
        ...
        hoje:{decisoes:5,riscos:3,pendencias:8,oportunidades:4,
          det:{
            ...
            oportunidades:'1) BB Giro de R$ 400 mil livre para capital de giro.\n2) Areia fora do Imposto Seletivo na reforma.\n3) Recuperar 0–30 dias (R$ 107,9 mil) rapidamente.\n4) Fundo de Compensação de ICMS (habilitação).'
          }
        },
        nota:'Inadimplência: dados REAIS (ACOMPCOB 11/08). Caixa/A Receber referência de 24/07. Nenhuma ação de alto impacto sem sua autorização.',
        graf:[
          ...
          {tipo:'donut',tit:'Inadimplência por idade',unid:'R$ 833,9 mil · total',
           partes:[{nome:'0–30 dias',val:107.92,cor:'#2dff8c'},{nome:'30–90 dias',val:55.60,cor:'#e6c15a'},{nome:'+90 dias',val:670.37,cor:'#ff5b6e'}],
           q:'Analise a composição por idade da inadimplência da SKAL em 11/08 (0–30: R$ 107,9 mil; 31–60: R$ 38,0 mil; 61–90: R$ 17,6 mil; +90 dias: R$ 670,4 mil, 80% do total de R$ 833,9 mil): o total caiu vs 10/08 mas o +90 subiu; o que é recuperável, o que é risco de perda, e qual a estratégia de cobrança por faixa.'},
        ...
        entradas:{data:'11/08 · fluxo',
          cards:[['Faturamento do dia','R$ 166,7 mil','ok'],['Resgatado','R$ 14,6 mil','ok'],['Venceu no dia','R$ 0,3 mil','aten'],['Previsão 13–19/08','R$ 515,6 mil','oport']],
          graf:{tipo:'bars2',tit:'Previsão de entrada · 13–19/08',unid:'R$ mil',cats:['13/08','14/08','17/08','18/08','19/08'],
            series:[{nome:'Previsto',cor:'#57b6ff',vals:[84.76,64.93,90.61,173.04,102.28]}]},
          q:'Analise as entradas do dia 11/08 da SKAL (faturamento do dia R$ 166.662,84 — à vista NFe 33.741,29, NG 7.597,00, a prazo 125.324,55; resgatado de inadimplência R$ 14.608,52; venceu e não pagou R$ 303,84) e a previsão de entrada de 13 a 19/08 (13/08 84.755,32; 14/08 64.928,94; 17/08 90.609,97; 18/08 173.035,79; 19/08 102.281,23; total 515.611,25). O que isso diz sobre o fluxo de caixa da semana, considerando a folha mensal (~124 mil líquido) e as saídas recorrentes, e o que priorizar na cobrança e no caixa?'},
