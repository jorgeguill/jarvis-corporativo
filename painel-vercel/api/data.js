    ...
    var DATA={
      SKAL:{nome:'SKAL Engenharia',status:'aten',dados:true,
        ...
        eventos:[
          ...
          {t:'crit',tp:'Paradas · CORREÇÃO',tt:'CORREÇÃO IMPORTANTE: as 13 fichas antes lidas como "falta de água" são, na verdade, FALTA DE AREIA (erro de leitura do relatório manual/OCR). Logo a MAIOR causa de parada é ABASTECIMENTO DE AREIA SECA, não água. Isso casa com o forno: ele secou 15.139 t vs 17.983 t consumidas — não seca rápido o suficiente para alimentar a produção, então a linha para por falta de areia. Depois vêm equipamento (rosca de cimento, ensacadeira, esteira), mão de obra e energia. Prioridade nº 1: destravar a secagem/estoque de areia (capacidade do forno + estoque mínimo de areia seca).',q:'Explique por que a maior parada da produção da SKAL é falta de areia (e não água), a ligação com a capacidade do forno de secagem, e o que fazer para destravar.'},
          {t:'oport',tp:'Estratégia',tt:'Diagnóstico (corrigido): o gargalo é ABASTECIMENTO DE AREIA SECA (13 paradas) + equipamento + sequência, não capacidade da linha. A areia seca vem do forno; se o forno não seca no ritmo do consumo (secou 15.139 t vs 17.983 t consumidas), a linha para. Destravar: aumentar capacidade/estoque de areia seca (forno) e garantir estoque mínimo. Mix concentrado (top 3 = 90%) pede produção por CAMPANHAS + SMED. Programa de 90 dias: capacidade de secagem + estoque de areia, ativos críticos, campanhas, captura digital de tempos/perdas, custeio padrão. Falta o custo unitário dos insumos para fechar o custo por saco.',q:'Explique o programa de 90 dias da produção da SKAL, começando por destravar o abastecimento de areia seca (forno).'},
        ...
        graf:[
          ...
          {tipo:'bars2',tit:'Previsão de caixa · a receber × a pagar',unid:'R$ mil · em aberto por mês (Lançamentos 2026, 17/08)',cats:['Ago','Set','Out','Nov','Dez'],
           series:[{nome:'A receber',cor:'#2dff8c',vals:[1381.4,1763.7,492.1,128.1,7.9]},{nome:'A pagar',cor:'#ff5b6e',vals:[894.5,579.5,310.0,240.5,194.7]}],
           q:'Monte a PREVISÃO DE CAIXA da SKAL com os títulos em ABERTO do Movimento 2026 (a liquidar), por mês de vencimento. A RECEBER em aberto (R$ mil): ago 1.907,5; set 1.763,7; out 492,1; nov 128,1; dez 7,9. A PAGAR em aberto (R$ mil): ago 1.785,9; set 579,5; out 310,0; nov 240,5; dez 194,7. Total em aberto: a receber R$ 7,17 mi, a pagar R$ 5,45 mi (posição líquida +1,72 mi). Realizado no ano: recebido R$ 22,2 mi, pago R$ 21,7 mi. Some às saídas recorrentes NÃO incluídas no ledger de fornecedores se for o caso (folha dia 03 ~152,3 mil; tributos dia 17 ~263,8 mil; encargos ~dia 20 ~70 mil) — antes, verifique se já estão no contas a pagar para não contar em dobro. Confronte com caixa ~827,3 mil e crédito livre 400 mil. Conclua mês a mês: sobra ou aperta, e a partir de quando a cauda de recebíveis esvazia (out/nov). Trate contas a pagar só para frente como previsão.'},
