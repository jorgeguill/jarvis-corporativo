...
function buildData(){
    ...
    (function(){var s=DATA.SKAL;if(!s.graf)return;var receita=s.graf[0],aging=s.graf[1];
      var fiscal={tipo:'bars2',tit:'Tributos a recolher · 07/2026',unid:'R$ mil · vencem 17/08',cats:['ICMS ST','ICMS Norm','FUNEF','COTAC','Parc.','DIFAL'],
        series:[{nome:'A recolher',cor:'#ff5b6e',vals:[124.27,95.67,30.62,7.65,4.25,1.33]}],
        q:'Analise os tributos estaduais da SKAL apurados em 07/2026 (SPED filial 0002-89, PI), todos com vencimento 17/08/2026: ICMS ST R$ 124.271,52; ICMS Normal R$ 95.674,61; Taxa FUNEF R$ 30.615,88; Taxa COTAC R$ 7.653,97; parcelamento ICMS (parcela 05/60) R$ 4.254,80; DIFAL uso/consumo R$ 1.332,62 — total R$ 263.803,40. Lembre que o Crédito Presumido de 80% (Lei 6.146/11) abateu R$ 382.698,45 de ICMS no mês e que o IPI acumula saldo credor de R$ 650,5 mil. Explique a composição, o peso da ST, e o que monitorar.'};
