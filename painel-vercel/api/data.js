    ...
    var DATA={
      SKAL:{nome:'SKAL Engenharia',status:'aten',dados:true,
        ...
        eventos:[
          ...
          {t:'oport',tp:'Fluxo de caixa',tt:'Movimento 2026 (títulos em aberto): a receber R$ 6,61 mi × a pagar R$ 5,35 mi (líquido +1,26 mi). No ano já foram recebidos R$ 19,9 mi e pagos R$ 19,1 mi. Agosto sobra bem (receber 2,26 mi × pagar 1,18 mi); de out em diante a cauda de recebíveis esvazia e o giro passa a depender de novo faturamento. Há ~R$ 3,35 mi de recebíveis atrasados (jan–jul) a cobrar.',q:'Monte a previsão de caixa da SKAL mês a mês com os títulos em aberto do Movimento 2026 (a receber × a pagar) e diga a partir de quando aperta.'},
