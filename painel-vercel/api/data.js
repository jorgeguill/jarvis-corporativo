      ...
      SKAL:{nome:'SKAL Engenharia',status:'aten',dados:true,
        ...
        graf:[
          ...
          {tipo:'fluxo',tit:'Fluxo de caixa projetado',unid:'R$ mil · saldo acumulado (cenário conservador)',
           meses:['24/07','Ago','Set','Out','Nov','Dez'],
           saldo:[827.3,1244.2,1942.1,1637.9,1039.2,366.1],
           linhas:[['Ago',1381.4,964.5,416.9,1244.2],['Set',1763.7,1065.8,697.9,1942.1],['Out',492.1,796.3,-304.2,1637.9],['Nov',128.1,726.8,-598.7,1039.2],['Dez',7.9,681.0,-673.1,366.1]],
