    ...
    var DATA={
      SKAL:{nome:'SKAL Engenharia',status:'aten',dados:true,
        kpis:[
          ...
          {l:'Inadimplência',v:'R$ 903,1 mil',st:'crit'},
        ...
        eventos:[
          ...
          {t:'crit',tp:'Crítico',tt:'Inadimplência total R$ 903,1 mil (18/08) — recuou R$ 3,4 mil desde 17/08; o dia teve R$ 9,1 mil de novos atrasos e R$ 12,5 mil resgatados. Acima de 90 dias: R$ 720,3 mil (79,8% da dívida). Tirando os 3 casos especiais (MRV 94,9 mil em cobrança judicial, Vanguarda 49,3 mil, Rivello 173,8 mil), a inadimplência operacional (soma das faixas líquidas) é R$ 584,6 mil — 0–30 R$ 70,1 mil; 31–60 R$ 63,7 mil; 61–90 R$ 6,6 mil; +90 R$ 444,2 mil. É nessa dívida operacional que a régua de cobrança deve focar.',q:'Detalhe a inadimplência de 18/08 por faixa e a inadimplência operacional (sem MRV, Vanguarda e Rivello), com as faixas líquidas.'},
          ...
          {t:'oport',tp:'Custo',tt:'MODELO DE CUSTO POR PRODUTO (bottom-up, auditável). Metodologia: custo/saco = Σ(kg do insumo por saco × R$/kg do insumo) + embalagem, com kg/saco = kg do traço ÷ 100 (linha 15 kg) ou ÷ 75 (Multiuso 20 kg). Receita REAL por saco de 15 kg (Banco Mestre REV4, aba Materiais): Master Super Top → areia 11,31 kg + cimento 3,50 + resina 0,15 + celulose 0,035 + carbonato 0,005 + 1 embalagem; Interna Plus (a mais barata, SEM resina) → areia 11,97 + cimento 3,00 + celulose 0,03 + carbonato 0,005; Externa → areia 11,91 + cimento 3,00 + resina 0,05 + celulose 0,035; Gold → areia 11,28 + cimento 3,50 + resina 0,18. PREÇOS REAIS já apurados das notas de compra (NF-e): CIMENTO CP V ARI granel R$ 495/t = R$ 0,495/kg — preço FIRME, confirmado em dois meses seguidos (jan 565,95 t + fev 340,46 t = ~906 t ao mesmo preço); EMBALAGEM saco valvulado R$ 487/mil = R$ 0,487/saco; CARBONATO (calcário dolomítico #170) R$ 244/t = R$ 0,244/kg (a confirmar se é o mesmo carbonato da receita). Com isso, o custo JÁ CALCULÁVEL por saco (cimento + carbonato + embalagem) é R$ 2,22 no Master/Gold (350 kg cimento/traço) e R$ 1,97 na Interna Plus/Externa (300 kg/traço). Ranking de custo (dirigido por resina + cimento): Master/Gold/Piscina/Porcelanato Ext/Sobrepor = os mais caros; Interna Plus/Estrutural = os mais baratos. FALTAM 4 preços: AREIA (produção própria: draga + secagem no forno, não é preço de compra), KIT RESINA, KIT CELULOSE e INCORPORADOR DE AR — não vieram limpos em janeiro nem fevereiro (fev tem OCR sujo); buscar em outro mês ou direto no Financeiro. Enquanto não chegam, areia e esses aditivos ficam DADO A CONFIRMAR. Cruzamento com o top-down (matéria-prima R$ 2,78/saco médio): sobra ~R$ 1,05/saco para areia + resina + celulose — coerente. Origem: extração fiscal de compras jan+fev/2026 (Itens_Produtos) + aba Materiais (receita).',q:'Mostre o modelo de custo por produto (bottom-up): a receita por saco de cada argamassa, os preços reais já apurados de janeiro (cimento R$ 0,495/kg, embalagem R$ 0,487, carbonato R$ 0,244/kg), o custo já calculável por saco e os 4 insumos que faltam (areia, resina, celulose, incorporador).'},
        ...
        nota:'Inadimplência: dados REAIS (ACOMPCOB 18/08). Caixa: posição BB de 17/08. Nenhuma ação de alto impacto sem sua autorização.',
        graf:[
          ...
          {tipo:'donut',tit:'Inadimplência por idade',unid:'R$ 903,1 mil · total',
           partes:[{nome:'0–30 dias',val:96.15,cor:'#2dff8c'},{nome:'30–90 dias',val:86.68,cor:'#e6c15a'},{nome:'+90 dias',val:720.30,cor:'#ff5b6e'}],
        ...
        entradas:{data:'18/08 · fluxo',
          cards:[['Faturamento do dia','R$ 152,9 mil','ok'],['Entrou em conta','R$ 102,0 mil','ok'],['Resgatado','R$ 12,5 mil','ok'],['Ficou em atraso','R$ 9,1 mil','crit']],
          graf:{tipo:'bars2',tit:'Previsão de entrada · 20–26/08',unid:'R$ mil',cats:['20/08','21/08','24/08','25/08','26/08'],
            series:[{nome:'Previsto',cor:'#57b6ff',vals:[59.77,52.79,102.27,245.62,96.48]}]},
          q:'Analise as entradas do dia 18/08 da SKAL (faturamento do dia R$ 152.892,88 — a vista Oficial 69.706,31, a vista NG 9.253,20, a prazo 73.933,37; entrou em conta R$ 102.034,53 = boletos 97.823,73 + depositos 4.210,80; previsto era 74.588,29; resgatado de inadimplencia R$ 12.510,27; ficou em atraso R$ 9.111,29) e a previsao de entrada de 20 a 26/08 (20/08 59.773,03; 21/08 52.791,60; 24/08 102.274,40; 25/08 245.617,60; 26/08 96.483,87; total 557.940,50). Destaque o pico previsto de 25/08 (R$ 245,6 mil) e o que priorizar na cobranca.'},
