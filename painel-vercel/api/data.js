    ...
    var DATA={
      SKAL:{nome:'SKAL Engenharia',status:'aten',dados:true,
        kpis:[
          ...
          {l:'Inadimplência',v:'R$ 797,5 mil',st:'crit'},
        ...
        eventos:[
          ...
          {t:'crit',tp:'Crítico',tt:'Inadimplência total R$ 797,5 mil (26/08) — recuou R$ 35,3 mil desde 24/08; o dia teve só R$ 12,0 mil de novos atrasos e R$ 33,2 mil resgatados (resgate > atraso, bom sinal). Acima de 90 dias: R$ 640,4 mil (80,3% da dívida) — travado, é a dívida antiga que não se move. Tirando os 3 casos especiais (MRV 94,9 mil em cobrança judicial, Vanguarda 49,3 mil, Rivello 175,3 mil), a inadimplência operacional (soma das faixas líquidas) é R$ 478,0 mil — 0–30 R$ 34,4 mil; 31–60 R$ 78,4 mil; 61–90 R$ 12,5 mil; +90 R$ 352,8 mil. É nessa dívida operacional que a régua de cobrança deve focar.',q:'Detalhe a inadimplência de 26/08 por faixa e a inadimplência operacional (sem MRV, Vanguarda e Rivello), com as faixas líquidas.'},
          ...
          {t:'crit',tp:'Controle · Incentivos',tt:'CONTROLE DE VENCIMENTOS DOS INCENTIVOS (quadro de acompanhamento — o benefício decresce e vence, então cada linha precisa de data e % vigente):\n• SKAL Engenharia · ICMS/PI · concessivo Decreto 40.249/2000 (Lei 4.859/96) · prorrog. Decreto 15.925/2014 · % vigente 2026: A CONFIRMAR · validade: A CONFIRMAR.\n• QUIMIKA Industrial (11.262.306/0001-32) · ICMS/PI · concessivo Decreto 14.300/2010 (alt. 45.954/2015) · prorrog. regida pelo Decreto 19.408/2020 · % e validade 2026: A CONFIRMAR.\n• FCK — Ind. e Com. Mat. Construção (08.794.766/0001-05) · ICMS/PI · concessivo Decreto 12.645/2007 · prorrog. 13.275/2008 · esquema 100→90→80→60% (parecer ia até 31/12/2020) · situação 2026: A CONFIRMAR (pode já estar em faixa menor ou vencido).\n• LEI DO BEM (Lei 11.196/2005 · federal · P&D) · status: em avaliação (Projeto de Aproveitamento).\nAÇÃO: puxar no e-Process/SEFAZ-PI o ato vigente de cada empresa (percentual atual + data de expiração + próxima prorrogação) e cadastrar a data-alerta. O de 80% da SKAL abate ~R$ 383 mil/mês — perder por prazo é o maior risco fiscal do grupo.',q:'Monte o controle de vencimentos dos incentivos por empresa (SKAL, QUIMIKA, FCK): decreto, percentual vigente, data de expiração e próxima prorrogação. Aponte o que confirmar no e-Process/SEFAZ e a data-alerta de cada um.'},
          {t:'crit',tp:'Segurança',tt:'SEGURANÇA DO APLICATIVO — diagnóstico do novo agente de Segurança. JÁ ESTÁ BEM: as chaves de IA ficam só no servidor (nunca vão ao celular), senha conferida de forma segura, token com validade e páginas fora do Google. RISCOS a corrigir, por prioridade — P0 (urgente): (1) definir a variável RADAR_SECRET com um valor aleatório forte no Vercel — sem ela, se a lista de usuários vazar, dá para forjar um acesso; (2) limitar tentativas de login (hoje não há trava contra chute de senha em massa). P1 (alto): senhas em texto puro (usar senha forte e única por pessoa), CORS aberto, e faltam cabeçalhos de segurança (estes já foram adicionados). Ponto que você levantou (várias máquinas): o login de 7 dias vale em qualquer aparelho e não há como "desconectar todos" nem ver quem está logado — a saída imediata é trocar o RADAR_SECRET, que derruba todas as sessões de uma vez. Toque para o plano de ação completo por severidade.',q:'Como agente de Segurança, liste os riscos do aplicativo por severidade (P0/P1/P2), o que já está protegido, e o passo a passo prático para o Jorge blindar contra invasão, roubo de senha e acesso em várias máquinas.'},
        ...
        nota:'Inadimplência: dados REAIS (ACOMPCOB 26/08, base desde 01/08/2021). Caixa: posição BB + CEF de 25/08 (R$ 651,2 mil). Nenhuma ação de alto impacto sem sua autorização.',
        graf:[
          ...
          {tipo:'donut',tit:'Inadimplência por idade',unid:'R$ 797,5 mil · total',
           partes:[{nome:'0–30 dias',val:61.86,cor:'#2dff8c'},{nome:'30–90 dias',val:95.25,cor:'#e6c15a'},{nome:'+90 dias',val:640.38,cor:'#ff5b6e'}],
