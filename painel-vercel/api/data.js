    ...
    var DATA={
      SKAL:{nome:'SKAL Engenharia',status:'aten',dados:true,
        ...
        eventos:[
          ...
          {t:'oport',tp:'Custo',tt:'MODELO DE CUSTO POR PRODUTO (bottom-up, auditável). Metodologia: custo/saco = Σ(kg do insumo por saco × R$/kg do insumo) + embalagem, com kg/saco = kg do traço ÷ 100 (linha 15 kg) ou ÷ 75 (Multiuso 20 kg). Receita REAL por saco de 15 kg (Banco Mestre REV4, aba Materiais): Master Super Top → areia 11,31 kg + cimento 3,50 + resina 0,15 + celulose 0,035 + carbonato 0,005 + 1 embalagem; Interna Plus (a mais barata, SEM resina) → areia 11,97 + cimento 3,00 + celulose 0,03 + carbonato 0,005; Externa → areia 11,91 + cimento 3,00 + resina 0,05 + celulose 0,035; Gold → areia 11,28 + cimento 3,50 + resina 0,18. Único preço já fechado: cimento ≈ R$ 0,90/kg → a parcela de cimento é R$ 3,15/saco nos produtos de 350 kg/traço (Master, Gold, Piscina, Porcelanato Ext, Sobrepor) e R$ 2,70/saco nos de 300 kg/traço (Interna Plus, Externa, Porcelanato Int, Estrutural). Ranking de custo (dirigido por resina + cimento): Master/Gold/Piscina/Porcelanato Ext/Sobrepor = os mais caros; Interna Plus/Estrutural = os mais baratos. FALTAM 7 preços unitários para fechar o custo real e a margem por produto: areia R$/kg, kit resina R$/kg, kit celulose R$/kg, carbonato R$/kg, incorporador de ar R$/kg e embalagem R$/un (cimento já temos). Enquanto não chegam, areia e aditivos ficam DADO A CONFIRMAR. Origem: aba Materiais (receita, pronta) + aba Custos_Insumos (preços, vazia — a preencher pelo Financeiro).',q:'Mostre o modelo de custo por produto (bottom-up): a receita por saco de cada argamassa, o que já dá para calcular com o preço do cimento e os 7 preços que faltam para fechar a margem.'},
