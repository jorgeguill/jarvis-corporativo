    ...
    var DATA={
      SKAL:{nome:'SKAL Engenharia',status:'aten',dados:true,
        ...
        eventos:[
          ...
          {t:'oport',tp:'Fluxo de caixa',tt:'Lançamentos a pagar/receber 2026 (posição 17/08): em aberto a receber R$ 7,17 mi × a pagar R$ 5,45 mi → líquido +R$ 1,72 mi. No ano já circularam R$ 22,2 mi recebidos e R$ 21,7 mi pagos (carteira equilibrada). Por mês, setembro é o mais folgado (receber 1,76 mi × pagar 0,58 mi); nov/dez as saídas superam a cauda de recebíveis. Sobre o a pagar ainda somam, por fora, folha (dia 03) e tributos (dia 17). A cobrança dos recebíveis atrasados segue como a maior alavanca.',q:'Monte a previsão de caixa da SKAL com os lançamentos 2026 (a receber 7,17 mi × a pagar 5,45 mi em aberto), mês a mês, somando folha (dia 03) e tributos (dia 17), e diga quando sobra ou aperta.'},
        ...
        graf:[
          ...
          {tipo:'bars2',tit:'Previsão de caixa · a receber × a pagar',unid:'R$ mil · em aberto por mês (Lançamentos 2026, 17/08)',cats:['Ago','Set','Out','Nov','Dez'],
           series:[{nome:'A receber',cor:'#2dff8c',vals:[1907.5,1763.7,492.1,128.1,7.9]},{nome:'A pagar',cor:'#ff5b6e',vals:[1785.9,579.5,310.0,240.5,194.7]}],
