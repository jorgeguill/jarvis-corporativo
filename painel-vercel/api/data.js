    ...
    var DATA={
      SKAL:{nome:'SKAL Engenharia',status:'aten',dados:true,
        ...
        eventos:[
          ...
          {t:'aten',tp:'Permutas · Patrimônio',tt:'Dossiê de permutas: 13 imóveis FINALIZADOS (patrimônio — Brisa do Leste, Prince Tower, Madri, Porto Príncipe, American Flat, Smart, Village do Sol casa+loja, Villa do Conde, 2 terrenos Cavalaria, terreno Parnaíba, Franklin Chakal) e 8+ EM ANDAMENTO (Boa Vista/Carnaúba, Cessão Onerosa/Amaré, Gávea/Vistamar, Contrato Direto, Connect Life 409, Connect Life 1007/Rivello, Triunfo, Vanguarda/Studio V — nesta a SKAL é compradora). Valores dos finalizados a confirmar (contratos escaneados). Nos Encontros de Contas, o total de notas mistura permuta com venda normal — não é o saldo da permuta. Prioridade: apurar o valor de cada imóvel e registrar no imobilizado.',q:'Liste as permutas da SKAL (finalizadas e em andamento), explique por que o total de notas do encontro de contas não é o saldo da permuta, e o que falta para registrar os imóveis no patrimônio.'},
          ...
          {t:'oport',tp:'Fluxo de caixa',tt:'Posição por previsão de baixa (retrato 17/08): a receber R$ 4,22 mi × a pagar a fornecedores R$ 3,74 mi → líquido +R$ 476 mil a realizar em 2026. Sobre o a pagar de fornecedores ainda somam, por fora, folha (~152 mil, dia 03), tributos (~264 mil, dia 17) e encargos (~70 mil). No ano já circularam R$ 19,9 mi recebidos e R$ 19,1 mi pagos. Agosto sobra bem; a cobrança dos recebíveis atrasados é a maior alavanca.',q:'Monte a previsão de caixa da SKAL com a posição oficial por previsão de baixa (a receber 4,22 mi × a pagar fornecedores 3,74 mi), somando folha (dia 03), tributos (dia 17) e encargos, e diga se sobra ou aperta mês a mês.'},
        ...
        graf:[
          ...
          {tipo:'bars2',tit:'Previsão de caixa · a receber × a pagar',unid:'R$ mil · em aberto por mês (Movimento 2026)',cats:['Ago','Set','Out','Nov','Dez'],
           series:[{nome:'A receber',cor:'#2dff8c',vals:[2260.2,788.2,175.8,14.3,1.6]},{nome:'A pagar',cor:'#ff5b6e',vals:[1177.5,352.2,206.2,142.9,138.9]}],
           q:'Monte a PREVISÃO DE CAIXA da SKAL com os títulos em ABERTO do Movimento 2026 (a liquidar), por mês de vencimento. A RECEBER em aberto (R$ mil): ago 2.260,2; set 788,2; out 175,8; nov 14,3; dez 1,6 (total futuro ~3.240; mais atrasados jan–jul ~3.352 a cobrar). A PAGAR em aberto (R$ mil): ago 1.177,5; set 352,2; out 206,2; nov 142,9; dez 138,9. Total em aberto: a receber R$ 6,61 mi, a pagar R$ 5,35 mi (posição líquida +1,26 mi). Some às saídas recorrentes NÃO incluídas no ledger de fornecedores se for o caso (folha dia 03 ~152,3 mil; tributos dia 17 ~263,8 mil; encargos ~dia 20 ~70 mil) — antes, verifique se já estão no contas a pagar para não contar em dobro. Confronte com caixa ~827,3 mil e crédito livre 400 mil. Conclua mês a mês: sobra ou aperta, e a partir de quando a cauda de recebíveis esvazia (out/nov). Trate contas a pagar só para frente como previsão.'}
        ],
