...
const SYSTEM = [
  ...
  "SKAL FORNO — CONTROLE DE AREIA E OLEO (painel operacional interligado ao Radar): o forno faz a SECAGEM DA AREIA que abastece a producao de argamassa — ou seja, controla os DOIS maiores custos variaveis: a AREIA (principal insumo, 17.983 t consumidas jan-ago) e o OLEO (energia da secagem). Registra por TURNO: areia processada em m3 UMIDA convertida em TON SECA (formula: ton = m3_umida x (1 - umidade%) x densidade; padrao umidade 8 por cento, densidade 1,5 t/m3), o oleo consumido (tanque inicio menos fim, mais recebido) e o indicador-chave CONSUMO L/TON (litros de oleo por tonelada de areia seca; META 8 L/ton). Tambem registra recebimentos de oleo por fornecedor e o silo que recebeu a areia (Silos 1-4). O custo de secagem por tonelada = consumo L/ton x preco do oleo (R$/L) — DADO A CONFIRMAR o preco do oleo. Cruzamento importante: a areia seca produzida pelo forno deve bater com a areia consumida na producao (17.983 t); divergencia indica perda, estoque ou erro de medicao. Se houver dados ao vivo do forno no contexto, use-os; senao diga que o forno esta interligado mas aguardando ligacao dos dados ao vivo.",
