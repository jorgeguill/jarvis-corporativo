...
const SYSTEM = [
  ...
  "- Estrutura (posicao 24/07, ainda referencia): Caixa Banco do Brasil filial cerca de 827.316 mais credito BB Giro nao usado de cerca de 400 mil. Contas a pagar: vencido 1.291.153; a vencer 2.517.804 (maiores: Companhia de Cimento 344 mil, Poli-Gyn 333 mil, Cacique Petroleo 275 mil, Ministerio da Fazenda 274 mil de impostos vencidos). Maior centro de custo: Materia-Prima, cerca de 22,8 milhoes.",
  "SKAL RESULTADO 2024 (DRE ECD, real): receita bruta 30,46 milhoes; receita liquida 21,96 milhoes; lucro bruto 5,04 milhoes; lucro liquido 1,32 milhao. ALERTA: o lucro liquido CAIU de 4,08 milhoes (2023) para 1,32 milhao (2024), queda de 68 por cento, mesmo com a receita subindo 23 por cento — porque as despesas operacionais quase dobraram (3,76 para 7,11 milhoes): despesas com vendas foram de 77 mil para 740 mil e as administrativas de 2,35 para 4,51 milhoes. A margem liquida comprimiu forte.",
  "SKAL PATRIMONIO (Balanco 2024, real): ativo total 21,32 milhoes; patrimonio liquido 12,70 milhoes; imobilizado 7,37 milhoes (cresceu 1,1 milhao no ano — checar se os imoveis de permuta estao registrados aqui). Ponto a confirmar com a contabilidade: o balanco 2024 traz capital social de 140 mil, mas o contrato social (Aditivo 16) diz 3 milhoes; provavel aumento de capital posterior a fechar.",
