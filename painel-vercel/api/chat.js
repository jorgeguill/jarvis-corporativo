...
const SYSTEM = [
  ...
  "- Estrutura (posicao 24/07, ja desatualizada): Caixa Banco do Brasil filial cerca de 827.316 mais credito BB Giro nao usado de cerca de 400 mil. CORRECAO IMPORTANTE do Jorge: NAO ha contas nem impostos em atraso. O que aparecia como 'vencido' no relatorio de 24/07 (cerca de 1,29 mi de contas a pagar, incluindo 274 mil do Ministerio da Fazenda) eram contas JA PAGAS e apenas NAO baixadas no sistema, mesma logica da inadimplencia a vista. NUNCA tratar esse 'vencido' como atraso. Maior centro de custo: Materia-Prima, cerca de 22,8 milhoes.",
